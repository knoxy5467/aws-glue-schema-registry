 ...
 *
 * The region defaults to us-east-2 (matching the harness's default). Override
 * via the AWS_REGION env or the request's "region" field if present.
 *
...
public final class RealGlueClient {
     ...
     * us-east-2 to match the project default.
     */
