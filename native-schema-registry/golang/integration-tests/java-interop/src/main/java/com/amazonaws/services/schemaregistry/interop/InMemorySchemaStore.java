 ...
 *
 * The sidecar never calls AWS Glue. Tests pass the schemaVersionId UUID in
 * the encode request; that UUID is what ends up in the GSR header. Decode
 * lookups go against this store using the UUID parsed out of the header.
 *
